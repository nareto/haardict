...
hd = Test(learnimgs,npatches,patch_size,noisevar=0.3)
hd.learn_dict(method='centroids-dict', dictsize=6, clustering='spectral')
...
##hd.show_rec_img()
#hd.print_results()
hd.print_and_save_orgmode('asdf/',simhist=True,saveimgs=True)
